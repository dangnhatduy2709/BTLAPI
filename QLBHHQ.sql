...
VALUES
    ('LH001', N'Bưởi da xanh lão trái 800g - 1kg'),
    ('LH002', N'Nho xanh không hạt 500g'),
    ('LH003', N'Cam sành 0.9-1.1kg'),
    ('LH004', N'Dua hấu đỏ trái 1.7kg - 2kg'),
    ('LH005', N'Bánh Bauli Moonfils Vị Dâu 45G')

INSERT INTO MatHang (LoaiHangID, MatHangID, TenHang, DVTinh, SLTon)
VALUES
    ('LH001', 'MH001', N'Bưởi da xanh lão trái 800g - 1kg', N'Gói', 20),
    ('LH001', 'MH002', N'Nho xanh không hạt 500g', N'Gói', 15),
    ('LH002', 'MH003', N'Cam sành 0.9-1.1kg', N'Gói', 10),
    ('LH002', 'MH004', N'Dua hấu đỏ trái 1.7kg - 2kg', N'Gói', 12),
    ('LH003', 'MH005', N'ổi nữ hoàng 0.9-1kg', N'Gói', 8)
